...
BOOST_AUTO_TEST_CASE( min40_bdd1 )    { minimize_all( "bdd", "bdd", ctx,  40); }

BOOST_AUTO_TEST_CASE( min20_bdd2 )    { minimize_all( "bdd", "adder", ctx,  20); }
BOOST_AUTO_TEST_CASE( min40_bdd2 )    { minimize_all( "bdd", "adder", ctx,  40); }

BOOST_AUTO_TEST_CASE( min20_adder1 )  { minimize_all( "adder", "bdd", ctx,  20); }
BOOST_AUTO_TEST_CASE( min40_adder1 )  { minimize_all( "adder", "bdd", ctx,  40); }

BOOST_AUTO_TEST_CASE( min20_adder2 )  { minimize_all( "adder", "adder", ctx,  20); }
BOOST_AUTO_TEST_CASE( min40_adder2 )  { minimize_all( "adder", "adder", ctx,  40); }
...
BOOST_AUTO_TEST_CASE( max40_bdd1 )    { maximize_all( "bdd", "bdd", ctx,  40); }

BOOST_AUTO_TEST_CASE( max20_bdd2 )    { maximize_all( "bdd", "adder", ctx,  20); }
BOOST_AUTO_TEST_CASE( max40_bdd2 )    { maximize_all( "bdd", "adder", ctx,  40); }

BOOST_AUTO_TEST_CASE( max20_adder1 )  { maximize_all( "adder", "bdd", ctx,  20); }
BOOST_AUTO_TEST_CASE( max40_adder1 )  { maximize_all( "adder", "bdd", ctx,  40); }

BOOST_AUTO_TEST_CASE( max20_adder2 )  { maximize_all( "adder", "adder", ctx,  20); }
BOOST_AUTO_TEST_CASE( max40_adder2 )  { maximize_all( "adder", "adder", ctx,  40); }
