  ...
  namespace solver {
    ...
    struct smt2_solver_pipe {
	 ...
	 return *_result;
      ...
      std::ostream_iterator<char> current_pos() {
        return std::ostream_iterator<char>(*_solver);
      }
	...
	return expr::simplify( e );
      ...
      void assertion( result_type e ) {
        ...
        dump_decls( e );
        out_ << "(assert ";
        std::ostream_iterator<char> it(out_.current_pos());
        expr::print_expression(it, e, table_);
        out_ << ")\n";
      }
      ...
      result_wrapper read_value( result_type const var ) {
        out_ << "(get-value (";
        std::ostream_iterator<char> out_it(out_.current_pos());
        expr::print_expression(out_it, var, table_);
        out_ << "))\n";
